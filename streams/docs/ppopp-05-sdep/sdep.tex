...
\begin{center}
\vspace{-12pt}
\psfig{figure=sdep-example3.eps,width=5.8in}
\vspace{-4pt}
...
p(n) \hspace{-5.5pt}&=&\hspace{-5.5pt} \lfloor \frac{n}{|{\cal S} \wedge E|} \rfloor~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\hspace{1.3pt}~~~~~~~~~(1) \\[1Ex] % I can't get the Eq. number to appear here any other way :(
...
While Equation~(2) is valid for $\sdepf{A}{E}$, the general form
...
\hspace{-3.5pt}q(n) * |{\cal S} \wedge Y| + & \hspace{-3pt} \mbox{otherwise} \\[1Ex] %(\mbox{if~} n > 2*|{\cal S} \wedge X|)\\[1Ex]
