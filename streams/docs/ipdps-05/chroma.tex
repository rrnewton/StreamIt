...
A contrast of chrominance format support between the StreamIt and  C
...
difference between chrominance formats is merely a change in
...
indices, and pointer offsets on the chrominance format; the reference
...
the 4:2:2 and 4:2:0 chrominance formats, and lines 7-9 provide
