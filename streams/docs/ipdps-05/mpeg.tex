...
up of pixels arranged in a 16x16 array known as a macroblock.  A
macroblocks consists of a 2x2 array of blocks, each of which contains
an 8x8 array of pixels. Macroblocks specify colors using a {\it
...
macroblock from 16x16 to 8x8 pixels. An alternate chrominance format
is 4:2:2. It uses two blocks for each chrominance channel,
downsampling each of the channels from 16x16 to 8x16 pixels. The two
