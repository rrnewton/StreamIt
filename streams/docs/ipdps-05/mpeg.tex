...
up of a 16x16 group of pixels known as a macroblock.  A macroblock
...
Macroblocks specify colors in terms of their luminance and 
chrominance components. Because of human insensitivity to hue
the chrominance channels are frequently downsampled. 
The type of downsampling an MPEG-2 encoder
