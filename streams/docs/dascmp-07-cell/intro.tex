...
on data parallel applications, giving a reasonable 3\% library
overhead, and at least 88\% utilization on pipelined applications,
giving an acceptable 12\% library overhead. The amount of code
