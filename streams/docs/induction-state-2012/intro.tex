...
\caption{(a) Example StreamIt filter based on AssignPictureType, used in MPEG Encoder. Uses induction variable state.  (b) The AssignPictureType filter rewritten using the iteration keyword. \protect\label{fig:apt-pipeline}}
\end{figure}
