...
together (Blender).  Though we have yet to implement a fully automatic
translation to generate the plugins from StreamIt source code, we do
not forese foresee any major hurdles in doing so.
...
output value, due to the saturating arithmetic.  In such cases, the
