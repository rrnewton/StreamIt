...
\vspace{-6pt}
\caption{The bit reverse order filter in the FFT, with N=8.  The tapes illustrate the data re-shuffling.  The Butterfly stage is similar, but ommitted for lack of space.
