...
% Figure~\ref{fig:firstreamit}, is implemented as a {\tt Filter} that
...
% multi-stage butterfly in the FFT. 

% % ommitted for lack of space
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% %As shown in
% %Figure~\ref{fig:fft-butterfly}, the Butterfly filter is also
