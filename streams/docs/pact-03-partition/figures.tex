  \clearpage
\begin{figure*}[t]
\psfig{figure=beamformer.eps,width=3.5in} ~~
\psfig{figure=bitonic.eps,width=3.5in} ~~
\\ ~
\psfig{figure=fft.eps,width=3.5in}
\psfig{figure=filterbank.eps,width=3.5in} ~~
\\ ~ 
\psfig{figure=fir.eps,width=3.5in} ~~
\psfig{figure=targetdetect.eps,width=3.5in}
\caption{Scaling results for dynamic programming and greedy partitioners on the cycle-accurate Raw simulator.}
\end{figure*}
