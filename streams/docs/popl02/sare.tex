...
computation for dataflow languages; we designed the PCG to provide a
model of computation for the StreamIt programming
language~\cite{streamitcc}.  A PCG is a generalization of the
