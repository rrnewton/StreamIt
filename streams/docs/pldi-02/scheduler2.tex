...
schedules will be a multiple of these \cite{bhat1996x1}.  Thus, the
...
\cite{bhattamurtlee97, bhat1996x1}) on SAS's because their minimal
code size allows extensive function inlining, which enables compiler
