...
To evaluate the performace of our compiler, we compare the StreamIt implementation
to two other implementations of the applications.  To facilitate
comparison 

The performance of the compiled code for the above applications is


For the GSM
application, we obtained a hand-coded implementation for comparis 
given in Table \ref{tab:performance}.  We compare the StreamIt 
