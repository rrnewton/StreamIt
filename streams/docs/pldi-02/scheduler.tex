...
The buffer size requirement between any two filters is dictated solely by
the sequence of execution of these two filters.  The minimum buffer size
requirement is given by 
$MinBuffer(A,B) = \over{push_A  pop_B}{gcd (push_A, pop_B}}$
\cite{murthy94combined}
