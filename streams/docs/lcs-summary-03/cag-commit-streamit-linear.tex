...
graph. Automating the optimization allows DSP programmers to write simple, 
modular filters and leave complex combination and optimizations 
to the compiler. We have developed algorithms for a {\it linear expansion} operation 
...
This work is supported in part by a grant from DARPA (PCA F29601-04-2-0166), 
