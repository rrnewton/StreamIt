...
\begin{figure}
  \begin{center} \psfig{figure=beam-blood-key.eps,width=3.25in} \\
    ...
    Original.\label{fig:fm-blood1}]{\psfig{figure=radio-blood-orig.eps,width=3in}}
    \hspace{0.3in} \subfigure[\vspace{-6pt}
    Load-balanced.\label{fig:fm-blood2}]{\psfig{figure=radio-blood-opt.eps,width=3in}
...
We use the FM Radio application \cite{pca} to illustrate the
