...
\psfig{figure=beam-blood-orig.eps,width=3in}
\vspace{-12pt}
\caption{\protect\small Blocking diagram for BeamFormer before load balancing.
\protect\label{fig:fmblood1}}
\end{minipage}
\hspace{0.3in}
\vspace{-12pt}
\begin{minipage}{3.1in}
\psfig{figure=beam-blood-opt.eps,width=3in}
\caption{\protect\small Blocking diagram for the load-balanced partitioning of BeamFormer.
