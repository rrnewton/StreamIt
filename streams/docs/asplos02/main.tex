...
\title{A Stream Compiler for Communication-Exposed Architectures\thanks{This document is the {\bf second version} of MIT Laboratory for Computer Science Technical Memo LCS-TM-627.}}
