...
variable.  Of course, these graphs have (by definition) a one-to-one
correspondence with a set of recurrence equations, but they are more
trivial than the graphs described above, in that they only produce and
consume one item per firing and do not have a concept of phases or
peeking.
...
scientific programs have have also been utilized for powerful storage
