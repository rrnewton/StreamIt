...
$\vec{{\cal I}}$ and $\vec{\cal A}$, each of which is a complex-valued
vector of length $N$.  Element-wise multiplication of $\vec{\cal I}$
and $\vec{\cal A}$ yields a vector $\vec{Y}$, to which the inverse
