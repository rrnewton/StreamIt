...
will come to represent the linear node. The values of 
$\mt{pushcount}$ and $\mt{popcount}$ when a push or pop is encountered
are used to determine the appropriate locations within $A$ and ${\vec b}$.
