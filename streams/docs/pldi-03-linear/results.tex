...
\vspace{-6pt}
\caption{Elimination of floating point operations.}
\label{fig:flops}
\vspace{-12pt}
\end{table}
\end{figure*}
...
%% \begin{figure}[t]
%% \vspace{-6pt}
%% \caption{Execution speedup for maximal linear replacement, maximal frequency replacement, and automatic selection of optimizations.}
