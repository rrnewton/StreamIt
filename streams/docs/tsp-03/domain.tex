...
\item \emph{Occasional modification of stream structure.}  Even though
  ...
  adding some filters to clean up the signal; a software radio
  re-initializes a portion of the stream graph when a user switches
  from AM to FM.  Sometimes, these re-initializations are synchronized
  with some data in the stream--for instance, when a network protocol
  changes from Bluetooth to 802.11 at a certain point of a
