...
\begin{figure}[t]
\hspace{-0.9in}\psfig{figure=fm-sir-tree.eps,width=6.6in}
...
\vspace{-6pt}
\begin{center}
\hspace{0pt}\psfig{figure=fm-after-linear.eps,width=2.5in}
\vspace{-6pt}
...
\begin{figure}[t]
\psfig{figure=fm-after-partition.eps,width=4.6in}
