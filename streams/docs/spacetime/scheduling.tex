...
\begin{figure}
\centering
\psfig{figure=slice-shapes.eps,width=2.5in}
\vspace{-6pt}
...
%For the current configuration the cost function is the critical path
%length of the schedule.  This calculation .  Calculating this
%interaction requires

%we determine the work assigned to
...
%Simulated annealing is a form of stochastic
