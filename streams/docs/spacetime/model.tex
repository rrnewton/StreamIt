...
\begin{figure}[t]
\centering
\psfig{figure=slice-schedule.eps,width=3.0in}
...
%\footnote{Note that our technique is not just limited to
...
%However we leave it to future work to make this extension.}