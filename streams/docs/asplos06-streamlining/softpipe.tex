\begin{figure}[t]
\psfig{figure=pipeline-scaling.eps,width=3in}
\end{figure}
...
from SUBSET-SUM~\cite{sipser-textbook}), we use a greedy partitioning
...
available for buffering stream data.  In addition, the unrolling
...
Lastly, and most importantly, we can use this synergy to fully
