...
speedups normalized to single-core for most configurations. First, we
present a description of the benchmark suite employed in the
evaluation.
...
achieves a mean speedup of 1.40x over sequential StreamIt. For four of
our benchmarks, fine-grained duplication on 16 cores has lower
throughput than single-core.
...
over this baseline. Please note that the version of
