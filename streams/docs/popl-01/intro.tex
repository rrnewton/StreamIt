...
as C++ to implement stream programs, resorting to low-level assembly
codes for performance-critical loops.  This practice is
...
characterize the domain of streaming programs for which StreaMIT is
intended.
