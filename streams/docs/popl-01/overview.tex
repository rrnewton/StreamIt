...
\caption{The frequency-hopping mechanism of our software radio provides an example of StreaMIT's messaging system.  In {\tt TrunkedRadio}, a Portal is created to hold the message target, {\tt rf2if}.  Then, {\tt CheckFreqHop} uses the Portal to send a frequency-change message.}
