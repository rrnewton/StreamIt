...
\[
\begin{array}{c}
(n(t_1), \dots , n(out_A), \dots, n(t_k)); \\ {\cal P}((n(t_1), \dots , n(out_A + push_A), \dots, n(t_k))) \\ \hline (n(t_1), \dots , n(out_A + push_A), \dots, n(t_k))
\end{array}
\]
...
\[
\begin{array}{c}
(n(t_1), \dots , n(out_A), \dots, n(t_k), D); \\
{\cal P}((n(t_1), \dots , n(out_A + push_A), \dots, n(t_k), D)); \\
D - pop_A + push_A \le MAXITEMS \\ \hline (n(t_1), \dots , n(out_A + push_A), \dots, n(t_k), D - pop_A + push_A)
\end{array}
\]
