...
apply when there is a downstream path $P_1$ from the filter preceding
$x$ to the filter following $y$, a downstream path $P_2$ from the
filter preceding $y$ to the filter following $z$, and the paths $P_1$
