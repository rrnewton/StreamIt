...
\begin{figure}[tbh]
  \centerline{\includegraphics[width=3.0in]{streamgraph.pdf}}
  \caption{The Stream Graph for the Channel Vocoder.  The ovals
represent filters and the arrows are the arcs.}
  \label{streamgraph}
\end{figure}
