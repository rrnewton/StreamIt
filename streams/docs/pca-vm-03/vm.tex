...
\req{
  ...
  If called from within a kernel, than that kernel is {\tt k}.  (Kernels may not pause other kernels.)}
...
\req{
  {\tt k} is {\tt Running}, {\tt Paused}, or {\tt Finished}.\\
  If called from within a kernel, than that kernel is {\tt k}.  (Kernels may not end other kernels.)}
