...
{\small
\begin{verbatim}
void streamInitWithDataRAM(Stream* s, MM_ELMT_MEM ramLocation, int address, 
...
{\small
\begin{verbatim}
void streamInitFIFO(Stream* s, MM_ELMT_MEM fifoLocation, 
...
{\small
\begin{verbatim}
void kernelInit(Kernel* k, MM_ELMT_PROC procLocation, IOBlock* scratch,
...
void stridedScatterInit(StridedScatter* scatter, MM_ELMT_PROC location, 
...
void stridedGatherInit(StridedGather* gather, MM_ELMT_PROC location, 
...
void indexedScatterInit(IndexedScatter* scatter, MM_ELMT_PROC location,
...
void indexedGatherInit(IndexedGather* gather, MM_ELMT_PROC location, 
...
%%   } Move;
%%
%%   void moveInit(Move* move, MM_ELMT_PROC location, IStream* _srcStr, OStream* _destStr,
