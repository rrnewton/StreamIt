...
kernels are mapped to the resources.  There are many ways in which
this draining functionality can be implemented using the primitives
...
\begin{verbatim}
  ...
  sumInit(PopKernel* k, VM_NODE_PROC procLocation, IStream* _in, int _capacity, boolean _boundedRemainder) {
