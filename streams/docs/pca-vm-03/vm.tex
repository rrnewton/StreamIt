...
\req{{\tt s1}, {\tt s2}, etc. have been initialized.}
...
\begin{verbatim}
  ...
  void svm_moveInit(svm_Move* move, mm_Proc location, svm_IStream* _srcStr, 
                    svm_OStream* _destStr, int _length, boolean _setEOS);
    kernelInit(&move->kernel, location, 0, move, sizeof(svm_Move), (ExtKernelWork)&moveWork);
    move->srcStr = _srcStr;
...
\begin{verbatim}
  typedef struct {
    ...
    int length,
    int destStride,
    int elementsPerStride
  } svm_StridedScatter;

  void svm_stridedScatterInit(svm_StridedScatter* scatter, mm_Proc location, 
                              svm_IStream* _srcStr, svm_OBlock* _destBlock, int _length,
                              int _destStride, int _elementsPerStride)
    kernelInit(&scatter->kernel, location, 0, scatter, sizeof(svm_StridedScatter), 
               (ExtKernelWork)&stridedScatterWork);
  ...
  void stridedScatterWork(svm_StridedScatter* scatter) {
    int iteration, j, num_items = 0;
...
\begin{verbatim}
  ...
  void svm_stridedGatherInit(svm_StridedGather* gather, mm_Proc location, 
                             svm_IBlock* _srcBlock, svm_OStream* _destStr, int _length,
                             int _srcStride, int _elementsPerStride, boolean setEOS)
    kernelInit(&gather->kernel, location, 0, gather, sizeof(svm_StridedGather), 
               (ExtKernelWork)&stridedGatherWork);
  ...
  void stridedGatherWork(svm_StridedGather* gather) {
    int iteration, j, num_items = 0;
    boolean done_stream_all = false;
...
\begin{verbatim}
  ...
  void svm_indexedScatterInit(svm_IndexedScatter* scatter, mm_Proc location, 
                              ...
                              svm_OBlock* _destBlock, int _length, int _elementsPerIndex)
    kernelInit(&scatter->kernel, location, 0, scatter, sizeof(svm_IndexedScatter), 
               (ExtKernelWork)&indexedScatterWork);
    scatter->srcStr = _srcStr;
  ...
  void indexedScatterWork(svm_IndexedScatter* scatter) {
    int iteration, j;
    boolean done_stream_all = false;
...
\begin{verbatim}
  ...
  void svm_indexedGatherInit(svm_IndexedGather* gather, mm_Proc location, 
                              ...
                              int _length, int _elementsPerIndex, boolean _setEOS)
    kernelInit(&gather->kernel, location, 0, gather, sizeof(svm_IndexedGather), 
               (ExtKernelWork)&indexedGatherWork);
    gather->srcBlock = _srcBlock;
  ...
  void indexedGatherWork(svm_IndexedGather* gather) {
    int iteration, j;
    boolean done_stream_all = false;
