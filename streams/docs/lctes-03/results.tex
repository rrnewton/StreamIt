...
Any application in {\StreamIt} must receive its data from
somewhere, and its data must be sent somewhere. {\filters} that
perform these functions are called sinks and sources. In
particular, sinks have the property of having $u_f = 0$ while
sources have $e_f = o_f = 0$. Sinks are problematic for minimal
latency scheduling, because they do not produce any data. Thus any
