...
channel following the firing of the shaded node.  Then, fine-grained
...
$\mt{maxPhases}$ phases, each of which is a single appearance
schedule.\protect\label{fig:sjex}}}
\end{figure*}
