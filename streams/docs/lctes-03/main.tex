...
{\splitjoin} and {\feedbackloop}, all of which are Streams
themselves. The smallest computational element of a {\StreamIt}
program is a {\filter}. {\StreamIt} uses a static rate
computational model, meaning that every {\filter}'s rate of
consumption and production of data is known at compile time.
%
