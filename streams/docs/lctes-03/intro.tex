...
gives a motivating example and describes relevant {\StreamIt}
...
\begin{figure}[t]
\psfig{figure=sched-diag2.eps,width=3.5in}
...
Shown in Figure~\ref{fig:trace}(b) is the minimum latency phased
...
\begin{figure}[t]
\psfig{figure=codedata.eps,width=3.5in}
