...
\begin{center}
  \subfigure[Collapsed pipeline.\label{fig:eg-hierarchy-collapsed}]{
    \framebox{\includegraphics[scale=.4, angle=0]{./hierarchy-eg1.pdf}}
  }
  \subfigure[Expanded splitjoin.\label{fig:eg-hierarchy-expanded}]{
    \framebox{\includegraphics[scale=.4, angle=0]{./hierarchy-eg2.pdf}}
  }
  \subfigure[Example pipeline with data in transit.\label{fig:dataflow}]{
    \framebox{\includegraphics[scale=.4, angle=0]{./dataflow-eg.pdf}}
  }
...
\noindent {\bf ACKNOWLEDGMENTS}\\ Special  thanks to William Thies who
