...
\begin{figure}
  \psfig{figure=beam-mult.eps,  scale=.4}
...
XXX-XXX\% compared to the baseline on the Petium. In the case of
\texttt{matmult} and \texttt{ofmd}, there is a slight degradation
(nearly 5\%) due to XXX. By comparsion, the scaling resutls on the
