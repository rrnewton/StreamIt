...
In general, scaling improves performance, with speedups ranging from
4-87\% compared to the baseline on the Pentium. In the case of
\texttt{matmult} and \texttt{ofdm}, there is a slight degradation
