...
offer a {\bf [[???]]} average speedup over the baseline and a 169\%
...
average speedups of 148\% for StrongARM, 58\% for Pentium~3, and 57\%
...
baseline is 250\% on StrongARM, 146\% on Pentium~3 and 144\% on
Itanium~2.
