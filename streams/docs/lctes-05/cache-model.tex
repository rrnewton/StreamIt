...
sequence of actor firings. 
The model is based on the notion of an actor reuse distance, which is 
based on the LRU stack distance~\cite{mattson70}. We develop the model
