...
\begin{figure}
  \psfig{figure=beam-mult.eps,  scale=.15}
  \psfig{figure=bisort-mult.eps,scale=.15}
  \psfig{figure=fbank-mult.eps, scale=.15}
  \psfig{figure=fftc-mult.eps,  scale=.15}
  \psfig{figure=fftf-mult.eps,  scale=.15}
  \psfig{figure=3gpp-mult.eps,    scale=.15}
  \psfig{figure=fir-mult.eps,    scale=.15}
  \psfig{figure=matmult-mult.eps,    scale=.15}
  \psfig{figure=fm-mult.eps,    scale=.15}
