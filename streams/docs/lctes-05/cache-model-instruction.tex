...
Using the instruction miss ($\mt{IMISS}$) metric in
...
\paragraph*{Scaling} A permutation of actor firings within a steady
...
\begin{figure}[t]
\begin{center}
  \psfig{figure=fftf-mult2.eps, width=\columnwidth}
% \nocaptionrule
