...
a speedup of 131\% for our streaming benchmark suite on a Pentium~3 
architecture, and a speedup of 114\% for the same benchmark suite on
...
82\% speedup for our benchmark suite on the Pentium~3, and 84\% speedup 
on the Itanium~2. Scaling gives a 43\% speedup over baseline for our 
...
do so, we can achieve a speedup of 131\% for our benchmark suite on a 
Pentium~3, and a speedup of 114\% on an Itanium~2 processor.
...
demonstrating speedup of up to 5800\% on Pentium~3 and up to 6400\% 
on Itanium~2.
\end{itemize}
