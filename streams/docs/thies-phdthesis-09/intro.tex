...
By adopting a stream programming model, non-expert programmers can
obtain order-of-magnitude speedups on certain classes of applications.
...
size~\cite{karczmarek-lctes03,karczma-thesis}.  Phil Sung and
