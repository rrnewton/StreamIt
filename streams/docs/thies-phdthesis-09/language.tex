...
%%     - author(s)
%%     - lines of code
%%     - number of static splitjoins, feedbackloops, filters, pipelines
%%
%%     automation:
%%     - number peeking
%%     - number stateless?
%%       - better: fraction of stateful work, largest work in stateful filter
%%     - number of dynamic filters, splitjoins, feedback loops (following collapse)
%%
%%     after:
%%     - stream graph
%%     - number of messaging pairs
%%     - parameterization (and default values of those parameters)
%%
%%     not doing:
%%     - dynamic control flow?
%%     - computation to communication ratio (do I trust work estimate?)
%%     - extent of peeking
%%     - extent of roundrobin weights
{\small
\begin{verbatim}
