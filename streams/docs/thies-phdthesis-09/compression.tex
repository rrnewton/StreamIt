...
\begin{figure}[t]
\psfig{file=compression/graph-speedup-pixel.eps,width=3.35in}
...
\begin{figure}[t]
\vspace{1.5pt}
\psfig{file=compression/graph-speedup-scatter.eps,width=3.47in}
...
\vspace{-4pt}
\psfig{file=compression/blender-background1-frame5.eps,width=1.09in}
\vspace{2pt}
\end{minipage}
\begin{minipage}{1.1in}
\vspace{-4pt}
\psfig{file=compression/blender-foreground2-frame5.eps,width=1.09in}
\vspace{2pt}
\end{minipage}
\begin{minipage}{1.1in}
\vspace{-4pt}
\psfig{file=compression/blender-composite-frame5.eps,width=1.09in}
\vspace{2pt}
\end{minipage}
...
\begin{minipage}{1.1in}
\psfig{file=compression/digvid-background1.eps,width=1.09in}
\vspace{2pt}
\end{minipage}
\begin{minipage}{1.1in}
\psfig{file=compression/digvid-matte1-frame.eps,width=1.09in}
\vspace{2pt}
\end{minipage}
\begin{minipage}{1.1in}
\psfig{file=compression/digvid-composite.eps,width=1.09in}
\vspace{2pt}
\end{minipage}
...
\begin{figure}[t]
\psfig{file=compression/graph-speedup-composite.eps,width=3.35in}
