...
%% \hspace{\myoffset}
\hspace{-0.25in}\psfig{file=profiling/intro-overview.eps,width=7in}
\vspace{-18pt}
...
\hspace{-0.05in}\psfig{file=profiling/mpeg2-addresses.eps,width=3.125in}
\vspace{-12pt}
...
\hspace{-0.05in}\psfig{file=profiling/mp3-addresses.eps,width=3.125in}
\vspace{-12pt}
...
\begin{figure*}[t]
\hspace{-0.25in}\psfig{file=profiling/program-changes.eps,width=7in}
...
This risk can be minimized by employing a rigorous quality assurance
...
%dynamic analysis, visualization tools, and parallelization macros,
%our approach immediately eases the burden of migrating C applications
%to a streaming representation that is suitable for multicore
%execution.
