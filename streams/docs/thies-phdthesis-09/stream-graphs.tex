...
% DUPLICATED with no teleport messages
\newcommand{\tallgraphcustomnomessage}[3]{
\clearpage
\begin{figure}[t!]
\vspace{-12pt}
\centering
\psfig{file=apps/#1.eps,height=\textheight}
\vspace{#3}
\caption[Stream graph for #2]{Stream graph for #2 (teleport messages not shown).\protect\label{fig:#1-graph}}
\vspace{-12pt}
\end{figure}}

\newcommand{\tallgraphnomessage}[2]{\tallgraphcustomnomessage{#1}{#2}{-12pt}}

\newcommand{\widegraphnomessage}[2]{
\clearpage
\begin{figure}[t!]
\vspace{-12pt}
\hspace{-0.025\textwidth}\psfig{file=apps/#1.eps,width=1.05\textwidth}
...
\widegraphnomessage{Mosaic}{Mosaic}
\widegraph{MP3}{MP3}
\tallgraph{MPD}{MPD}
\tallgraphnomessage{MPEG2-decoder}{MPEG2 decoder}
\widegraphnomessage{MPEG2-encoder}{MPEG2 encoder}
\widegraph{OFDM}{OFDM}
