...
small stream graph consisting of one or two actors. The patterns
distinguish between stateless and stateful actors. A stateless actor
...
within a processor. The actor's dynamic firings are guarded by the
