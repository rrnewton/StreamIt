...
\hbox{$Id: streamit-lang.tex,v 1.13 2003-01-22 20:34:05 dmaze Exp $}
}\fi}
...
\item A duplicate splitter may fire when at least the specified number
  of items is available on its input.  It pops this number of items
  from its input and pushes this number of items to each output.
\end{itemize}
