...
\hbox{$Id: streamit-lang.tex,v 1.10 2002-11-19 17:26:37 dmaze Exp $}
}}
\catcode`\$=3
...
The exact syntax of phased filters is currently under discussion.  It
is considered desirable to have both statically-scheduled phases,
where each phase executes a fixed number of times, and
dynamically-scheduled phases, where the number of executions can
depend on the input.
...
\item The names \lstinline|SplitJoin|, \lstinline|FeedbackLoop|,
  \lstinline|Filter|, \lstinline|Pipeline|, \lstinline|StreamIt|,
  \lstinline|Complex|, and \lstinline|data| are reserved.  Certain
  variable names beginning with underscores may cause conflicts if
