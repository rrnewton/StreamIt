...
public class CommonPasses {
	...
	public Slice[] run(SIRStream str, JInterfaceDeclaration[] interfaces,
		...
		System.out.println("at.dms.kjc.backendSupport.CommonPasses.run() "
				+ "printing str, name=" + str.getName());
		if (str instanceof SIRPipeline) {
			System.out.println("at.dms.kjc.backendSupport.CommonPasses.run() "
					+ "str is a pipeline");
			System.out.println("at.dms.kjc.backendSupport.CommonPasses.run() "
					+ "((SIRPipeline)str).getChildren().size()= "
					+ ((SIRPipeline) str).getChildren().size());
		}
		...
		// TODO: soule- End of my changes for partitioning. 
