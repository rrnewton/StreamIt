...
public class StaticSubGraph {
	...
	/** TODO: Remove this. Any filters that have a FileReader or FileWriter */
	...
	public StaticSubGraph init(StreamGraph parent, SIRStream str,
		...
		double CCRatio = CompCommRatio.ratio(str, work,
				executionCounts[1]);
		...
		flatten(sliceNodes, fg.top, edges,
