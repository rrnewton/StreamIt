...
public class StaticSubGraph {
    ...
    /** The identifier for this StaticSubGraph */
	private int id;
	...
	public static final String[] DO_NOT_CLONE_THESE_FIELDS = { "streamGraph" };
	...
	/**
	 * Return a unique identifier for each SSG.
	 * @return
	 */
...
//		System.out.println(topFilters);
	...
	public long getFilterWorkSteadyMult(WorkNode node) {
		return getFilterWork(node) * streamGraph.getSteadyMult();
	}
	...
	public long getWorkEstOneFiring(WorkNode node) {
		return (getFilterWork(node) / (node.getWorkNodeContent().getSteadyMult() / streamGraph
				.getSteadyMult()));
	}
	...
	protected void deepCloneInto(at.dms.kjc.slir.StaticSubGraph other) {
		...
		other.streamGraph = (at.dms.kjc.slir.StreamGraph) at.dms.kjc.AutoCloner
				.cloneToplevel(this.streamGraph);
