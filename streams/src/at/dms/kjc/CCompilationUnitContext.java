 ...
 *
 * $Id: CCompilationUnitContext.java,v 1.8 2006-03-24 15:54:47 dimock Exp $
 */
...
public class CCompilationUnitContext extends CContext {
    ...
    private /*final*/ Vector<CSourceClass>        classes;
    ...
    protected void deepCloneInto(at.dms.kjc.CCompilationUnitContext other) {
        ...
        other.classes = (java.util.Vector<CSourceClass>)at.dms.kjc.AutoCloner.cloneToplevel(this.classes);
