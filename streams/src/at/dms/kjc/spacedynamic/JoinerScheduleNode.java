...
public class JoinerScheduleNode {
    ...
    public String toString() {
        ...
        nextDup = (type == RECEIVE && next != null && next.type == DUPLICATE);
        ...
        if (type == DUPLICATE) {
            ...
            if (nextDup) {
                ...
                ret.append("__last" + buffer + " = __last" + buffer
                           + " & __MINUSONE__;\n");
            }
            ...
            ret.append("= initPath(" + initPathIndex + ");\n");
            ret.append("}\n");
            ret.append("__last" + buffer + " = __last" + buffer
                       + " & __MINUSONE__;\n");
        }
...
//                ret.append("));\n");
        ...
        ret.append("__first" + buffer + " = __first" + buffer
                   + " & __MINUSONE__;\n");
        return ret;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (type == DUPLICATE)
            ...
            return type == other.type && buffer.equals(other.buffer)
                && initPathIndex == other.initPathIndex;
    }
