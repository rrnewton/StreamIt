...
public abstract class Utils implements Serializable, DeepCloneable {
    ...
    public static JStatement makeForLoopLocalIndex(JStatement body,
        ...
        JExpression mult = new JMultExpression(
                null, 
                count, 
                multiplier
                );
    ...
    public static JForStatement makeBatchingLoop(JStatement body) {
        JIntLiteral count = new JIntLiteral(KjcOptions.threadbatch);
        JVariableDefinition loopIndex = new JVariableDefinition(/* where */ null,
                /* modifiers */ 0,
                /* type */ CStdType.Integer,
                /* ident */ 
                LoweringConstants.getUniqueVarName(),
        ...
        JStatement incr = 
                new JExpressionStatement(null,
                        new JPostfixExpression(null,
                                ...
                                null);
        JavaStyleComment comments[] = null;
        JVariableDefinition[] vars = {loopIndex};
        JStatement init = new  JVariableDeclarationStatement(vars);
        JForStatement forStatement = new JForStatement(null,
                init,
                cond,
                incr,
                body,
