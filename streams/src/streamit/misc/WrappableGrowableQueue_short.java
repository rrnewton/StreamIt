...
public class WrappableGrowableQueue_short implements WrappableGrowableQueue {
    ...
    public WrappableGrowableQueue_short() {
        sizeof_buffer = 2;
        buffer = new short[2];
        head = 0;
        tail = 0;
    ...
    private void grow(int size) {
        ...
        short[] new_buffer = new short[size];
        int new_head = 0;
        int new_tail = 0;
